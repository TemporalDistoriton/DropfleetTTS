#!/usr/bin/env python3
"""
TTS Ship Generator v18 — Template-Optimised (with Full Ship Data)
================================================================
...
SCRIPT_VERSION = "Gen18 full ship-data payload build 2026-08-06"
...
def locate_dfc_data_directory() -> Path:
    ...
    raise DataImportError(
        ...
        f"  {candidate}\n"
        "Place dfc-data-main beside Gen10_DFC_Data.py."
    )
